...
non-local guesses:
	 -org/http4s/state/addResult.
	 -org/http4s/state/addResult#
	 -org/http4s/state/addResult().
	 -org/http4s/dsl/io/state/addResult.
	 -org/http4s/dsl/io/state/addResult#
	 -org/http4s/dsl/io/state/addResult().
	 -java/util/concurrent/atomic/state/addResult.
	 -java/util/concurrent/atomic/state/addResult#
	 -java/util/concurrent/atomic/state/addResult().
	 -state/addResult.
	 -state/addResult#
	 -state/addResult().
	 -scala/Predef.state.addResult.
	 -scala/Predef.state.addResult#
	 -scala/Predef.state.addResult().
offset: 5825
    ...
    */
    ...
    def executeInstruction(i: Int): Unit = {
      ...
      thread_pool.execute {
        ...
        val timestamp = LocalDateTime.now()
        state.addRe@@sult(s"[${timestamp}] : ${instruct.output}")
