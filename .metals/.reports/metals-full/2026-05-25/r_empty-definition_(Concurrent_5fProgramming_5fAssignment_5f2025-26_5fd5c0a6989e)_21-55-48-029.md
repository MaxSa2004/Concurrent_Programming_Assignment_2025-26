error id: file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala:ServerState
file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol ServerState
offset: 588
...
object Routes {
  ...
  private val state = new ServerStat@@e()
  ...
  */
  ...
  private def parseAll(rawCommand: String): Instr = {
    ...
    Instr(instruction = output, delay = delay * 1000, afterDependencies = afterDependencies)
  }
