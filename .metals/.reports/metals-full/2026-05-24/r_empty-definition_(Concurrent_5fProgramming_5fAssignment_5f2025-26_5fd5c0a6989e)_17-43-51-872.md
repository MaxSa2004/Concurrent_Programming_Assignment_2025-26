...
non-local guesses:
	 -org/http4s/addCORSHeaders.
	 -org/http4s/addCORSHeaders#
	 -org/http4s/addCORSHeaders().
	 -org/http4s/dsl/io/addCORSHeaders.
	 -org/http4s/dsl/io/addCORSHeaders#
	 -org/http4s/dsl/io/addCORSHeaders().
	 -java/util/concurrent/atomic/addCORSHeaders.
	 -java/util/concurrent/atomic/addCORSHeaders#
	 -java/util/concurrent/atomic/addCORSHeaders().
	 -addCORSHeaders.
	 -addCORSHeaders#
	 -addCORSHeaders().
	 -scala/Predef.addCORSHeaders.
	 -scala/Predef.addCORSHeaders#
	 -scala/Predef.addCORSHeaders().
offset: 2446
    ...
    case GET -> Root / "reset" =>
     ...
     case req@GET -> Root / "run-simulation" =>
      ...
      case GET -> Root / "resume" =>
        paused = false
        Ok("SERVER RESUMED").map(addC@@ORSHeaders)
   }}
