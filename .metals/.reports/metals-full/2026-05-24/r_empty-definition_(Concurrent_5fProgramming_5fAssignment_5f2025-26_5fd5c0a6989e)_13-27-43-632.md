...
non-local guesses:
	 -org/http4s/instruct/instruction.
	 -org/http4s/instruct/instruction#
	 -org/http4s/instruct/instruction().
	 -org/http4s/dsl/io/instruct/instruction.
	 -org/http4s/dsl/io/instruct/instruction#
	 -org/http4s/dsl/io/instruct/instruction().
	 -java/util/concurrent/atomic/instruct/instruction.
	 -java/util/concurrent/atomic/instruct/instruction#
	 -java/util/concurrent/atomic/instruct/instruction().
	 -instruct/instruction.
	 -instruct/instruction#
	 -instruct/instruction().
	 -scala/Predef.instruct.instruction.
	 -scala/Predef.instruct.instruction#
	 -scala/Predef.instruct.instruction().
offset: 4751
