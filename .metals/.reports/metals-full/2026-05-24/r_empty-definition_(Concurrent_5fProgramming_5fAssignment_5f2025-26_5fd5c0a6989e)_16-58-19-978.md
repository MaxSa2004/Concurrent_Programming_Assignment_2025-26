error id: file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala:String
...
private case class Instr(instruction: Strin@@g, delay: Int, afterDependencies: List[Int])
...
private var firstFinished: Boolean = false
