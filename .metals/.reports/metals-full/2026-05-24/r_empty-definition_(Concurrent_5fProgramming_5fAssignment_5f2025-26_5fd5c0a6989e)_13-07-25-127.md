error id: file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala:AtomicInteger
file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol AtomicInteger
offset: 4059
  ...
  */
  ...
  private def runProcess(cmd: String, userIp: String): String = {
    ...
    */
    ...
    val remainin = remainingCounts.map(n => new A@@tomicInteger(n))
