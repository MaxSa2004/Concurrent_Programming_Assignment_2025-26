error id: file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala:map.
...
non-local guesses:
	 -org/http4s/remainingCounts/map.
	 -org/http4s/remainingCounts/map#
	 -org/http4s/remainingCounts/map().
	 -org/http4s/dsl/io/remainingCounts/map.
	 -org/http4s/dsl/io/remainingCounts/map#
	 -org/http4s/dsl/io/remainingCounts/map().
	 -java/util/concurrent/atomic/remainingCounts/map.
	 -java/util/concurrent/atomic/remainingCounts/map#
	 -java/util/concurrent/atomic/remainingCounts/map().
	 -remainingCounts/map.
	 -remainingCounts/map#
	 -remainingCounts/map().
	 -scala/Predef.remainingCounts.map.
	 -scala/Predef.remainingCounts.map#
	 -scala/Predef.remainingCounts.map().
offset: 4047
  ...
  */
  ...
  private def runProcess(cmd: String, userIp: String): String = {
    ...
    */
    ...
    val remainin = remainingCounts.ma@@p(n => new AtomicInteger(n))
