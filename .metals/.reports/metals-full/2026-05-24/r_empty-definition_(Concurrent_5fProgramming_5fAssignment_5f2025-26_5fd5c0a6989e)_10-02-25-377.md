error id: file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala:nonEmpty
file://<WORKSPACE>/exercise2/process-simulator/server/src/main/scala/cp/serverSim/Routes.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol nonEmpty
offset: 4318
...
object Routes {
  ...
  */
  ...
  private def parseIgnoreAfter(rawCommand: String): (String, Int) = {
    ...
    val delay = if(parts.length == 2 && parts(1).no@@nEmpty) parts(1).toInt else 0
